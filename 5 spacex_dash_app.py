...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Use all rows to render and return a pie chart graph to show the total success launches
        ...
        # Render and return a pie chart graph to show the success vs failed counts for the selected site
